...
parser.add_argument("ip", metavar = "X.X.X.X", action="store", help="The IP address of the Nexus switch")
parser.add_argument("port", action="store", help="The TCP/IP port that the NX-API process is using on the Nexus switch")
parser.add_argument("username", action="store", help="A username that can be used to log into NX-API on the Nexus switch")
parser.add_argument("password", action="store", help="The password for the specified username that can be used to log into NX-API on the Nexus switch")
...
nx_hosts = []
nx_hosts.append(args.ip)
nx_username = args.username
nx_password = args.password
nx_port = args.port
